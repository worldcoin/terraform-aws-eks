...
|------|-------------|------|---------|:--------:|
| <a name="input_"></a> [](#input\_) | List of node palb\_additional\_node\_portsorts which are accessible by ALB | `list(number)` | `[]` | no |
...
| <a name="input_external_alb_enabled"></a> [external\_alb\_enabled](#input\_external\_alb\_enabled) | External Application load balancers to create. If true, the ALB will be created. | `bool` | `true` | no |
