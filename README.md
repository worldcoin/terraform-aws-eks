...
| <a name="input_static_autoscaling_groups"></a> [static\_autoscaling\_groups](#input\_static\_autoscaling\_groups) | Configuration for static autoscaling group | <pre>object({<br>    size    = number<br>    mem_max = optional(number, 8192)<br>    mem_min = optional(number, 4096)<br>    cpu_max = optional(number, 4)<br>    cpu_min = optional(number, 2)<br>  })</pre> | `null` | no |
