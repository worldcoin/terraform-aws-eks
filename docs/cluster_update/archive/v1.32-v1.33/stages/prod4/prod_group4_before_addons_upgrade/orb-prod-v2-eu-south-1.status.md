...
TFH EKS login...
```console
2025/09/23 11:42:00 INFO Logging into AWS
2025/09/23 11:42:00 INFO Token found and valid
2025/09/23 11:42:02 INFO Switch WARP Virtual Network to name=tunnel-vpc-orb-prod-eu-south-1 id=898f0059-7316-4f08-ba47-14f3017b327b
2025/09/23 11:42:03 INFO Active WARP Virtual Network id=898f0059-7316-4f08-ba47-14f3017b327b
Added new context tfh-orb-prod-v2-eu-south-1 to /Users/lukasz.glowacki/.kube/config
```
...
ip-10-66-48-146.eu-south-1.compute.internal   Ready    <none>   21h     v1.32.8-eks-99d6cc0   10.66.48.146   <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   eks-node-al2023-orb-prod-v2-eu-south-1
ip-10-66-50-221.eu-south-1.compute.internal   Ready    <none>   10h     v1.32.8-eks-99d6cc0   10.66.50.221   <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
ip-10-66-50-36.eu-south-1.compute.internal    Ready    <none>   5h41m   v1.32.8-eks-99d6cc0   10.66.50.36    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
ip-10-66-51-154.eu-south-1.compute.internal   Ready    <none>   10h     v1.32.8-eks-99d6cc0   10.66.51.154   <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
ip-10-66-51-25.eu-south-1.compute.internal    Ready    <none>   21h     v1.32.8-eks-99d6cc0   10.66.51.25    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   eks-node-al2023-orb-prod-v2-eu-south-1
ip-10-66-52-120.eu-south-1.compute.internal   Ready    <none>   10h     v1.32.8-eks-99d6cc0   10.66.52.120   <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
ip-10-66-52-142.eu-south-1.compute.internal   Ready    <none>   3h28m   v1.32.8-eks-99d6cc0   10.66.52.142   <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
ip-10-66-52-145.eu-south-1.compute.internal   Ready    <none>   5h40m   v1.32.8-eks-99d6cc0   10.66.52.145   <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
ip-10-66-52-33.eu-south-1.compute.internal    Ready    <none>   3d9h    v1.32.8-eks-99d6cc0   10.66.52.33    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
ip-10-66-52-83.eu-south-1.compute.internal    Ready    <none>   24h     v1.32.8-eks-99d6cc0   10.66.52.83    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.aarch64   containerd://1.7.27   
ip-10-66-52-90.eu-south-1.compute.internal    Ready    <none>   3d18h   v1.32.8-eks-99d6cc0   10.66.52.90    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64    containerd://1.7.27   
```
...
ip-10-66-52-90.eu-south-1.compute.internal    Ready    <none>   <none>
```
...
3m57s       Warning   Unsupported        node/ip-10-66-48-146.eu-south-1.compute.internal   The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
9m20s       Normal    Unconsolidatable   node/ip-10-66-50-221.eu-south-1.compute.internal   SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
4m14s       Normal    Unconsolidatable   node/ip-10-66-50-36.eu-south-1.compute.internal    SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
9m20s       Normal    Unconsolidatable   node/ip-10-66-51-154.eu-south-1.compute.internal   SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
12s         Warning   Unsupported        node/ip-10-66-51-25.eu-south-1.compute.internal    The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
4m14s       Normal    Unconsolidatable   node/ip-10-66-52-120.eu-south-1.compute.internal   Can't remove without creating 2 candidates
4m14s       Normal    Unconsolidatable   node/ip-10-66-52-142.eu-south-1.compute.internal   SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
4m14s       Normal    Unconsolidatable   node/ip-10-66-52-145.eu-south-1.compute.internal   SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
15m         Normal    Unconsolidatable   node/ip-10-66-52-83.eu-south-1.compute.internal    SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
9m20s       Normal    Unconsolidatable   node/ip-10-66-52-90.eu-south-1.compute.internal    SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
```

Pods with issues
```
cloudflared-tunnel              cloudflared-tunnel-746c5477d5-grzl8                               0/1     CreateContainerConfigError   0          10h
cloudflared-tunnel              cloudflared-tunnel-746c5477d5-vfdmk                               0/1     CreateContainerConfigError   0          10h
```
...
Generated on: Tue Sep 23 11:42:32 CEST 2025
