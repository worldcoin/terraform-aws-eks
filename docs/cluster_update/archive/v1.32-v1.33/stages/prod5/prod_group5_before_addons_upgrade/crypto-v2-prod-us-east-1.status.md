...
TFH EKS login...
```console
2025/09/25 09:27:11 INFO Logging into AWS
2025/09/25 09:27:11 INFO Token found and valid
2025/09/25 09:27:13 INFO Switch WARP Virtual Network to name=tunnel-vpc-crypto-prod-us-east-1 id=c8ca54d1-de3b-4d42-a00d-abf0ed15d587
2025/09/25 09:27:15 INFO Active WARP Virtual Network id=c8ca54d1-de3b-4d42-a00d-abf0ed15d587
Added new context tfh-crypto-v2-prod-us-east-1 to /Users/lukasz.glowacki/.kube/config
```
...
ip-10-0-0-238.ec2.internal   Ready    <none>   5d11h   v1.32.8-eks-99d6cc0   10.0.0.238    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   eks-node-al2023-crypto-v2-prod-us-east-1
ip-10-0-1-132.ec2.internal   Ready    <none>   12h     v1.32.8-eks-99d6cc0   10.0.1.132    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   
...
ip-10-0-1-188.ec2.internal   Ready    <none>   5d21h   v1.32.8-eks-99d6cc0   10.0.1.188    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   
...
ip-10-0-1-96.ec2.internal    Ready    <none>   5h24m   v1.32.8-eks-99d6cc0   10.0.1.96     <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   
ip-10-0-2-119.ec2.internal   Ready    <none>   5d21h   v1.32.8-eks-99d6cc0   10.0.2.119    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   
ip-10-0-2-125.ec2.internal   Ready    <none>   5d6h    v1.32.8-eks-99d6cc0   10.0.2.125    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   
...
ip-10-0-3-206.ec2.internal   Ready    <none>   5d21h   v1.32.8-eks-99d6cc0   10.0.3.206    <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   
...
ip-10-0-3-70.ec2.internal    Ready    <none>   5d21h   v1.32.8-eks-99d6cc0   10.0.3.70     <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   
...
ip-10-0-5-44.ec2.internal    Ready    <none>   5d11h   v1.32.8-eks-99d6cc0   10.0.5.44     <none>        Amazon Linux 2023.8.20250908   6.1.148-173.267.amzn2023.x86_64   containerd://1.7.27   eks-node-al2023-crypto-v2-prod-us-east-1
...
ip-10-0-0-238.ec2.internal   Ready                   <none>   [map[effect:NoExecute key:critical]]
ip-10-0-1-132.ec2.internal   Ready                   <none>   <none>
ip-10-0-1-161.ec2.internal   Ready                   <none>   <none>
ip-10-0-1-188.ec2.internal   Ready                   <none>   <none>
...
ip-10-0-1-96.ec2.internal    Ready                   <none>   <none>
ip-10-0-2-119.ec2.internal   Ready                   <none>   <none>
...
3m22s       Normal    DisruptionBlocked   node/ip-10-0-0-112.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=signup-sequencer-phone-ethereum/signup-sequencer-phone-ethereum-0)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-0-162.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b1200t30-7ddc598df6-xc2jw)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-0-193.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-deletion-b10t30-857f5bfb5-24j4t)
3m22s       Warning   Unsupported         node/ip-10-0-0-238.ec2.internal   The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
12m         Normal    Unconsolidatable    node/ip-10-0-1-132.ec2.internal   NodePool "main-amd64" has non-empty consolidation disabled
3m22s       Normal    DisruptionBlocked   node/ip-10-0-1-161.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b600t30-6967fd87c6-82sj7)
3m33s       Normal    Unconsolidatable    node/ip-10-0-1-188.ec2.internal   NodePool "main-amd64" has non-empty consolidation disabled
3m22s       Normal    DisruptionBlocked   node/ip-10-0-1-199.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b100t30-7fd6577545-wrjgk)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-1-216.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-deletion-b100t30-78d796f865-bvvtj)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-1-34.ec2.internal    Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-deletion-b100t30-78d796f865-nmcvs)
6m37s       Normal    Unconsolidatable    node/ip-10-0-1-96.ec2.internal    NodePool "main-amd64" has non-empty consolidation disabled
4m44s       Normal    Unconsolidatable    node/ip-10-0-2-119.ec2.internal   NodePool "main-amd64" has non-empty consolidation disabled
4m45s       Normal    DisruptionBlocked   node/ip-10-0-2-125.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=world-chain-node/world-chain-node-0)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-2-169.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-deletion-b10t30-857f5bfb5-zzz2q)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-2-19.ec2.internal    Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b10t30-864bcb955-zvln2)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-2-234.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b1200t30-7ddc598df6-vcxsv)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-2-66.ec2.internal    Pdb prevents pod evictions (PodDisruptionBudget=world-id-relay/world-id-relay-pdb)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-3-119.ec2.internal   Pdb prevents pod evictions (PodDisruptionBudget=safe-transaction-service/safe-transaction-service-contracts-tokens-worker-pdb)
3m33s       Normal    Unconsolidatable    node/ip-10-0-3-206.ec2.internal   NodePool "main-amd64" has non-empty consolidation disabled
3m22s       Normal    DisruptionBlocked   node/ip-10-0-3-250.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b10t30-864bcb955-2tdvg)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-3-65.ec2.internal    Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=signup-sequencer-phone-ethereum/signup-sequencer-phone-ethereum-2)
3m33s       Normal    Unconsolidatable    node/ip-10-0-3-70.ec2.internal    NodePool "main-amd64" has non-empty consolidation disabled
3m22s       Normal    DisruptionBlocked   node/ip-10-0-5-17.ec2.internal    Pdb prevents pod evictions (PodDisruptionBudget=safe-transaction-service/sts-notifications-webhooks-worker-pdb)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-5-206.ec2.internal   Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=signup-sequencer-phone-ethereum/signup-sequencer-phone-ethereum-1)
3m59s       Warning   Unsupported         node/ip-10-0-5-44.ec2.internal    The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
3m22s       Normal    DisruptionBlocked   node/ip-10-0-5-97.ec2.internal    Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b100t30-7fd6577545-9dqqn)
17m         Normal    DisruptionBlocked   node/ip-10-0-5-97.ec2.internal    Pod has "karpenter.sh/do-not-disrupt" annotation (Pod=semaphore-mtb-orb/semaphore-mtb-orb-insertion-b600t30-6967fd87c6-8x7vf)
```

Pods with issues
```
world-chain-node                              world-chain-node-0                                                0/1     CrashLoopBackOff   1478 (2m22s ago)   5d6h
```
...
kube-system                                   coredns                                                N/A             1                 1                     625d
...
signup-sequencer-orb-ethereum                 signup-sequencer-orb-ethereum-pdb                      N/A             1                 1                     287d
signup-sequencer-phone-ethereum               signup-sequencer-phone-ethereum-pdb                    N/A             1                 1                     293d
tx-data-ingress                               tx-data-ingress-pdb                                    N/A             1                 1                     303d
tx-sitter-monolith                            tx-sitter-monolith-pdb                                 N/A             1                 1                     177d
world-chain-mainnet-archive-node-reth         world-chain-mainnet-archive-node-reth-op-node-pdb      N/A             1                 1                     23h
world-chain-mainnet-archive-node-reth         world-chain-mainnet-archive-node-reth-op-reth-pdb      N/A             1                 1                     23h
...
world-chain-node                              world-chain-node-pdb                                   50%             N/A               0                     5d6h
...
Generated on: Thu Sep 25 09:28:06 CEST 2025
