...
TFH EKS login...
```console
2025/09/18 19:12:25 INFO Logging into AWS
2025/09/18 19:12:25 INFO Token found and valid
2025/09/18 19:12:27 INFO Switch WARP Virtual Network to name=tunnel-vpc-df-enclave-stage-us-east-1 id=a8d86ecd-fbb0-4c53-802d-6ae766390581
2025/09/18 19:12:29 INFO Active WARP Virtual Network id=a8d86ecd-fbb0-4c53-802d-6ae766390581
...
ip-10-0-82-138.ec2.internal   Ready    <none>   9h    v1.32.8-eks-99d6cc0   10.0.82.138   <none>        Amazon Linux 2023.8.20250818   6.1.147-172.266.amzn2023.x86_64    containerd://1.7.27   eks-node-al2023-df-enclave-stage-us-east-1
ip-10-0-84-4.ec2.internal     Ready    <none>   9h    v1.32.8-eks-99d6cc0   10.0.84.4     <none>        Amazon Linux 2023.8.20250818   6.1.147-172.266.amzn2023.x86_64    containerd://1.7.27   
ip-10-0-84-44.ec2.internal    Ready    <none>   9h    v1.32.8-eks-99d6cc0   10.0.84.44    <none>        Amazon Linux 2023.8.20250818   6.1.147-172.266.amzn2023.aarch64   containerd://1.7.27   
ip-10-0-85-19.ec2.internal    Ready    <none>   9h    v1.32.8-eks-99d6cc0   10.0.85.19    <none>        Amazon Linux 2023.8.20250818   6.1.147-172.266.amzn2023.x86_64    containerd://1.7.27   eks-node-al2023-df-enclave-stage-us-east-1
ip-10-0-85-46.ec2.internal    Ready    <none>   8h    v1.32.8-eks-99d6cc0   10.0.85.46    <none>        Amazon Linux 2023.8.20250818   6.1.147-172.266.amzn2023.x86_64    containerd://1.7.27   
ip-10-0-85-79.ec2.internal    Ready    <none>   9h    v1.32.8-eks-99d6cc0   10.0.85.79    <none>        Amazon Linux 2023.8.20250818   6.1.147-172.266.amzn2023.x86_64    containerd://1.7.27   
```
...
3m8s        Warning   Unsupported         node/ip-10-0-82-138.ec2.internal   The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
2m38s       Normal    DisruptionBlocked   node/ip-10-0-84-4.ec2.internal     Pdb prevents pod evictions (PodDisruptionBudget=kube-system/ebs-csi-controller)
2m5s        Normal    Unconsolidatable    node/ip-10-0-84-44.ec2.internal    SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
2m38s       Warning   Unsupported         node/ip-10-0-85-19.ec2.internal    The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
11m         Normal    Unconsolidatable    node/ip-10-0-85-79.ec2.internal    Can't remove without creating 2 candidates
```

Pods with issues
```
kube-ops                  kube-ops-5dd97cf848-l5lv7                                         0/1     CrashLoopBackOff   112 (3m15s ago)   9h
```
...
deepface             deepface-backend-pdb                        N/A             1                 1                     6h54m
deepface             deepface-enclave-pdb                        N/A             1                 1                     7h8m
...
Generated on: Thu Sep 18 19:13:11 CEST 2025
