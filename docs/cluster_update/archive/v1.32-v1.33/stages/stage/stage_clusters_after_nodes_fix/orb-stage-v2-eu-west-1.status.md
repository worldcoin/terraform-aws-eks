...
TFH EKS login...
```console
2025/09/18 19:13:45 INFO Logging into AWS
2025/09/18 19:13:45 INFO Token found and valid
2025/09/18 19:13:47 INFO Switch WARP Virtual Network to name=tunnel-vpc-orb-stage-eu-west-1 id=ea718745-0878-456b-bf33-b3d760a03a66
2025/09/18 19:13:48 INFO Active WARP Virtual Network id=ea718745-0878-456b-bf33-b3d760a03a66
...
ip-10-57-17-61.eu-west-1.compute.internal    Ready    <none>   6h4m    v1.33.4-eks-99d6cc0   10.57.17.61    <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.x86_64    containerd://1.7.27   eks-node-al2023-orb-stage-v2-eu-west-1
ip-10-57-18-103.eu-west-1.compute.internal   Ready    <none>   6h3m    v1.33.4-eks-99d6cc0   10.57.18.103   <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.x86_64    containerd://1.7.27   eks-node-al2023-orb-stage-v2-eu-west-1
ip-10-57-18-122.eu-west-1.compute.internal   Ready    <none>   6h1m    v1.33.4-eks-99d6cc0   10.57.18.122   <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.aarch64   containerd://1.7.27   
ip-10-57-19-162.eu-west-1.compute.internal   Ready    <none>   5h57m   v1.33.4-eks-99d6cc0   10.57.19.162   <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.aarch64   containerd://1.7.27   
ip-10-57-20-229.eu-west-1.compute.internal   Ready    <none>   5h56m   v1.33.4-eks-99d6cc0   10.57.20.229   <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.x86_64    containerd://1.7.27   
ip-10-57-20-44.eu-west-1.compute.internal    Ready    <none>   5h57m   v1.33.4-eks-99d6cc0   10.57.20.44    <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.x86_64    containerd://1.7.27   
ip-10-57-20-48.eu-west-1.compute.internal    Ready    <none>   6h2m    v1.33.4-eks-99d6cc0   10.57.20.48    <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.x86_64    containerd://1.7.27   
ip-10-57-20-96.eu-west-1.compute.internal    Ready    <none>   5h58m   v1.33.4-eks-99d6cc0   10.57.20.96    <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.x86_64    containerd://1.7.27   
ip-10-57-21-11.eu-west-1.compute.internal    Ready    <none>   6h      v1.33.4-eks-99d6cc0   10.57.21.11    <none>        Amazon Linux 2023.8.20250818   6.12.40-63.114.amzn2023.x86_64    containerd://1.7.27   
```
...
2m41s       Warning   Unsupported        node/ip-10-57-17-61.eu-west-1.compute.internal    The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
111s        Warning   Unsupported        node/ip-10-57-18-103.eu-west-1.compute.internal   The instance type t3a.large is not supported for trunk interface (Security Group for Pods)
8m52s       Normal    Unconsolidatable   node/ip-10-57-18-122.eu-west-1.compute.internal   SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
8m52s       Normal    Unconsolidatable   node/ip-10-57-19-162.eu-west-1.compute.internal   SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
8m52s       Normal    Unconsolidatable   node/ip-10-57-20-229.eu-west-1.compute.internal   Can't remove without creating 2 candidates
17m         Normal    Unconsolidatable   node/ip-10-57-20-48.eu-west-1.compute.internal    SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
8m52s       Normal    Unconsolidatable   node/ip-10-57-20-96.eu-west-1.compute.internal    SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
8m52s       Normal    Unconsolidatable   node/ip-10-57-21-11.eu-west-1.compute.internal    SpotToSpotConsolidation is disabled, can't replace a spot node with a spot node
```

Pods with issues
```
cloudflared-tunnel              cloudflared-tunnel-746c5477d5-7ntrj                               0/1     CreateContainerConfigError   0          5h37m
cloudflared-tunnel              cloudflared-tunnel-746c5477d5-8zz9d                               0/1     CreateContainerConfigError   0          6h1m
```
...
Generated on: Thu Sep 18 19:14:05 CEST 2025
